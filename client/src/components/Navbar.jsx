...
<nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={()=> navigate("/cart")} className="relative cursor-pointer">
                    ...
                    <button className="absolute -top-2 -right-3 text-xs text-white bg-primary w-[18px] h-[18px] rounded-full">4</button>
                </div>
    ...
    border border-gray-200 py-2.5 w-[120px] rounded-md text-sm z-40'>
        ...
        <li onClick={logout} className='p-1 pl-3 hover:bg-primary/10 cursor-pointer'>Logout</li>
            ...
            {/* Mobile Menu */}
            { open && (
  <div className="flex absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden">
