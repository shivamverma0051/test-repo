...
const AddProduct = () => {
  ...
  return (
   <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flexflex-col
   justify-between">
            <form onChange={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                <div>
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <select  onChange={(e)=> setCtegory(e.target.value)} value={category}
                    id="category" className="outline-none md:py-2.5 py-2 px-3 
