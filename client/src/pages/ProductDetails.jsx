...
const ProductDetails = () => {
    ...
    const [relatedProducts, serRelatedProducts] = React.useState([]);
    ...
    useEffect(()=>{
        if(products.length > 0){
           ...
           productsCopy = productsCopy.filter(()=>product.category === item.category)
           console.log(productsCopy);

            serRelatedProducts(productsCopy.slice(0,5))
        }
    },[products])
